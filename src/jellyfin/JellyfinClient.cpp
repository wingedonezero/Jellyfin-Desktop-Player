...
{
    requestItems(QStringLiteral("/Users/%1/Items/Resume?Limit=24&MediaTypes=Video"
...
{
    requestItems(QStringLiteral("/Users/%1/Items?ParentId=%2&SortBy=SortName&SortOrder=Ascending"
                                "&Fields=PrimaryImageAspectRatio&EnableImageTypes=Primary,Backdrop,Thumb")
                     .arg(m_userId, parentId),
                 requestTag);
}
...
QUrl JellyfinClient::imageUrl(const QString &itemId, const QString &imageType, int maxHeight) const
{
